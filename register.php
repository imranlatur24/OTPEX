<?php 
 ...
 define('SMSUSER','imran24');
 define('PASSWORD','imran786');
 define('SENDERID','918208441436');
 
 
 //This function will send the otp 
 function sendOtp($otp, $phone){
 //This is the sms text that will be sent via sms 
 $sms_content = "Welcome To The Bizzmark IT company: Your verification code is $otp";
